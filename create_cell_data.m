...
df=dir('../data/trainingData/*.csv');   % uncomment to create training data
%df=dir('../data/validationData/*.csv');  % uncomment to create validation data
%df=dir('../data/testData/*.csv'); % uncomment to create test data
